// === SPICED CRANBERRY ORANGE PRODUCT SCRIPT ===

const PRODUCT_NAME = "Spiced Cranberry Orange";
...
function addNotifyButton() {
    ...
    if (!existing) {
        ...
        btn.textContent = "Notify Me"; // safe
...
function showInlineNotice(message) {
    ...
    notice.textContent = message; // safe
...
function updateCartCount() {
    ...
    cartCount.textContent = totalQty; // safe
}
...
function showToast(message) {
    ...
    toastMsg.textContent = message; // safe
...
function showFeedback(message, type = "error") {
    notifyFeedback.textContent = message; // safe
...
thumbImages.forEach(thumb => {
    thumb.addEventListener("click", () => {
        mainImg.src = thumb.getAttribute("data-main"); // safe
