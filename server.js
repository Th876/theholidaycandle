...
//         // Example: parse your metadata from the session
//         const cartItems = JSON.parse(session.metadata.cart);
...
//         // Optionally store order in MongoDB
//         await Order.create({
...
//                     await product.save();
//                 } else {
//                     console.warn(`Stock insufficient for ${item.name}`);
//                 }
//             }

//             console.log('✅ Stock decremented for session:', session.id);
//         } catch (err) {
//             console.error('❌ Error updating stock:', err);
//         }
//     }
...
//             // Optional: store session info or finalize reservation if you want
//             console.log('✅ Payment succeeded for session:', session.id);
//             // At this point, stock is already reserved and checkout completed.
//         } else if (
...
//         ) {
//             const session = event.data.object;
//             console.log('⚠️ Payment failed or expired for session:', session.id);
//             // TODO: If you want, you can release stock here if you stored reserved items linked to session.
//         }
//         res.json({ received: true });
//     } catch (err) {
